...
public class QueryController {
    ...
    @SkipCheckLogin
    @GetMapping("class")
    public Result<?> clazz(@Validated(Clazz.class) SearchVO vo) {
        return classService.getClassList(vo);
    }

    @SkipCheckLogin
    @GetMapping("campus")
    public Result<?> campus(@Validated(Campus.class) SearchVO searchVO) {
        return campusService.getCampusList(searchVO);
    }

    @SkipCheckLogin
    @GetMapping("institute")
    public Result<?> institute(@Validated(Institute.class) SearchVO searchVO) {
